...
<p>The cheapest reflow oven available online is around $100; additionally, this is from a site which has a questionable reputation. Since I was able to salvage some electronics components from old projects/appliances at home for the central controller, I decided to simply build my own to further reduce costs, only spending an extra $26 on a 240VAC relay and a thermocouple for precise temperature control.</p>
